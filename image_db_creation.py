...
insert_image('dog','F:\\College\\ТРПО\\TRPO Final\\Razvivushka\\images\\dog.png')
insert_image('gnezdo','F:\\College\\ТРПО\\TRPO Final\\Razvivushka\\images\\gnezdo.png')
insert_image('nora','F:\\College\\ТРПО\\TRPO Final\\Razvivushka\\images\\nora.png')
insert_image('budka','F:\\College\\ТРПО\\TRPO Final\\Razvivushka\\images\\budka.png')
insert_image('skvorechnik','F:\\College\\ТРПО\\TRPO Final\\Razvivushka\\images\\skvorechnik.png')
insert_image('balls','F:\\College\\ТРПО\\TRPO Final\\Razvivushka\\images\\balls.png')
conn.close()